...
public class VerPropuesta2 extends JFrame {
	
	private JTable table;
	private JTextField textField;
	
	public VerPropuesta2() {
		...
		*/
		...
		lblNewLabel.setBounds(129, 37, 46, 14);
		...
		panel.setBounds(10, 11, 258, 50);
		panel_3.add(panel);
		panel.setBorder(new LineBorder(new Color(0, 0, 0)));
		panel.setBackground(Color.ORANGE);
		panel.setLayout(null);
		
		JLabel lblCliente = new JLabel("Propuesta de ventas");
		lblCliente.setBounds(10, 11, 238, 30);
		lblCliente.setHorizontalAlignment(SwingConstants.CENTER);
		lblCliente.setFont(new Font("Arial", Font.BOLD, 22));
		panel.add(lblCliente);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(415, 11, 149, 50);
		panel_3.add(panel_1);
		...
		btnNewButton.setBounds(0, 0, 149, 50);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				VerPropuesta2.this.setVisible(false);
		...
		panel_5.setBounds(278, 11, 129, 50);
		panel_3.add(panel_5);
		
		JButton btnNewButton_2 = new JButton("Crear");
		btnNewButton_2.setBounds(0, 0, 130, 50);
