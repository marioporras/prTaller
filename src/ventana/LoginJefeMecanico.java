...
import java.awt.EventQueue;
	...
	public class LoginJefeMecanico extends JFrame implements ActionListener {
		...
		public LoginJefeMecanico() {
			...
			JLabel lblNombreTaller = new JLabel("JEFE MEC\u00C1NICOS");
			...
			btnEntrar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(!psdfContrasena.getText().contentEquals("") && !contra.contentEquals("")) {
						...
						if(miUsuarioDAO.pruebaLoginJefeMecanico(miUsuario)) {
